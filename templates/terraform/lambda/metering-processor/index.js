...
exports.handler = async (event) => {
    ...
    for (const record of event.Records) {
        ...
        try {
            ...
            if (msg.includes('UsageDimension')) tip = 'The dimension name does not match your Marketplace listing. Check the dimension value in the metering record and compare it to the pricing dimensions defined in your product listing. Dimension names are case-sensitive.';
            else if (msg.includes('InvalidProductCode') || msg.includes('invalid for ProductCode')) tip = 'The product code does not match your Marketplace listing. Verify the productCode value in the metering record matches the product code shown in your AWS Marketplace Management Portal.';
            else if (msg.includes('InvalidCustomerIdentifier') || msg.includes('CustomerAWSAccountId')) tip = 'The customer account ID is not recognized. Verify the customer completed registration through AWS Marketplace and the account ID matches the Subscribers table.';
